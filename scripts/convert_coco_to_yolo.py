...
def convert_coco_to_yolo():
    ...
    for img in coco_data["images"]:
        ...
        # Save relative path for split file: e.g. "dataset/images/subject_01/video_01/subject_01_video_01_frame_0001.jpg"
        img_rel_to_repo = str((Path("dataset") / rel_file_name).as_posix())
        split_image_paths[split_name].append(img_rel_to_repo)
    ...
    yaml_content = f"""# DMS-Eval YOLO Dataset Configuration
# Auto-generated by scripts/convert_coco_to_yolo.py

path: {repo_root.as_posix()}/dataset  # dataset root directory
train: {yolo_dir.as_posix()}/train.txt
val: {yolo_dir.as_posix()}/val.txt
test: {yolo_dir.as_posix()}/test.txt
...
"""
    ...
    root_yaml_content = f"""# DMS-Eval YOLO Dataset Configuration
path: {repo_root.as_posix()}
train: dataset/yolo/train.txt
val: dataset/yolo/val.txt
test: dataset/yolo/test.txt
