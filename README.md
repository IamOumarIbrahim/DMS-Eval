...
- **Unified Precision–Efficiency Protocol:** Identical hardware (RTX 4060), physical batch size 1 with gradient accumulation across 32 steps, 220 epochs, FP16 AMP, with detection accuracy and hardware-synchronized latency ($p50/p95/p99$) reported jointly.
...
| | **Physical Batch Size** | `1` | `1` | `1` | Strictly locked to 1 to simulate edge-in-the-loop streaming |
| | **Gradient Accumulation** | 32 steps (`nbs=32`) | 32 steps (`accum=32`) | 32 steps (`nbs=32`) | Effective nominal batch size = 32 (stabilizes Batch Normalization & gradients) |
