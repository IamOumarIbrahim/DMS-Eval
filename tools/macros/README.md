...
| **Active State (ON)** | Sends `Ctrl + Enter` continuously every **1.5 seconds** |
...
3. When navigating sequences of negative frames (no warning cues), **click the scroll wheel once** to start auto-advancing through frames every 1.5 seconds.
